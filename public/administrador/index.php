...
<body>
    <div class="panel-page-index">
        ...
        <div class="body-page">
            ...
            <h2>Manual de informacion</h2>
            <p class="descripcion-manual">Para el manejo y uso del sistema web, FDC CORP te brinda un manual de los pasos para el registro de usuarios, envios de correos masivos, control de los estados y toda las opciones que existen.</p>
            <a href="#" class="enlace-manual"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-file-earmark-post-fill" viewBox="0 0 16 16">
